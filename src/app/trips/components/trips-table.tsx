...
export function TripsTable({ trips, onDelete, onEdit, onCopy }: TripsTableProps) {
                ...
                <tr key={trip._id} className="bg-white">
                  <td className="px-4 py-4 cursor-pointer" onClick={() => navigate(`${trip._id}`)}>
                    <span className="font-medium flex flex-col">
                      ...
                      <p className="text-gray-500">{trip.departureLocation} to {trip.arrivalLocation}</p>
                    </span>
                  </td>
            ...
            <div key={trip._id} className="bg-white p-4 rounded-lg shadow-md cursor-pointer hover:bg-gray-100" onClick={() => navigate(`${trip._id}`)}>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">{trip.departureLocation} to {trip.arrivalLocation}</p>
                </div>
